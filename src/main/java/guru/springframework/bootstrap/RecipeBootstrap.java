...
/*Al inicializar la aplicacion se va generar objetos setados con data, que mediante ApplicationListener<ContextRefreshedEvent>,
* con su metodo que heredamos vamos a poder llenar la base de datos*/
@Component
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        /*saveAll, va guardar tod la informafion seteado en List<Recipe>*/
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        /*we're going to make sure that we actually get the expected UOM*/
        ...
        /*So here on the guacNotes we need to go in and set the recipe on guacNotes but also inversely,
        * on the guacRecipe, we need to set the notes object there and that's going to establish the ID value
        * and that bi-directional relationship*/
